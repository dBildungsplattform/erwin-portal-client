    ...
    <v-row justify="center">
      <v-col cols="12" md="10" lg="8">
        ...
        <v-tabs
          ...
          height="54"
        >
          <v-tab value="users" class="text-none text-body-2 font-weight-bold">
            <v-icon start class="mr-2">mdi-account-group-outline</v-icon>
            {{ t('help.tabs.users') }}
          </v-tab>
          <v-tab value="admins" class="text-none text-body-2 font-weight-bold">
            <v-icon start class="mr-2">mdi-shield-account-outline</v-icon>
            {{ t('help.tabs.admins') }}
          </v-tab>
        </v-tabs>
        ...
        <v-window v-model="activeTab" class="bg-transparent">
          ...
          <v-window-item value="users">
            ...
            <nav class="mb-8 pa-4 bg-grey-lighten-5 border rounded-xl" aria-label="Inhaltsverzeichnis">
            ...
            <div class="sections-wrapper">
              ...
              <!-- Section 1: Login -->
              <section id="login-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-login</v-icon>
                  </v-avatar>
                  <h3 class="text-h5 font-weight-bold text-slate-800">{{ t('help.users.loginTitle') }}</h3>
                </div>
                <!-- First login steps -->
                <v-card class="border-light rounded-xl pa-5" variant="flat">
                  <v-timeline density="compact" align="start" truncate-line="both">
                    <v-timeline-item dot-color="primary" size="small" icon="mdi-card-account-details-outline">
                      <div class="mb-1 font-weight-bold text-body-2">{{ t('help.gettingStarted.step1Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.gettingStarted.step1Text') }}</div>
                    </v-timeline-item>
                    
                    <v-timeline-item dot-color="primary" size="small" icon="mdi-login">
                      <div class="mb-1 font-weight-bold text-body-2">{{ t('help.gettingStarted.step2Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.gettingStarted.step2Text') }}</div>
                    </v-timeline-item>

                    <v-timeline-item dot-color="warning" size="small" icon="mdi-lock-reset">
                      <div class="mb-1 font-weight-bold text-body-2">{{ t('help.gettingStarted.step3Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.gettingStarted.step3Text') }}</div>
                    </v-timeline-item>

                    <v-timeline-item dot-color="success" size="small" icon="mdi-view-dashboard-outline">
                      <div class="mb-1 font-weight-bold text-body-2">{{ t('help.gettingStarted.step4Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.gettingStarted.step4Text') }}</div>
                    </v-timeline-item>
                  </v-timeline>
                </v-card>
              </section>
              ...
              <!-- Section 2: Profile -->
              <section id="profile-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-account-outline</v-icon>
                  </v-avatar>
                  <h3 class="text-h5 font-weight-bold text-slate-800">{{ t('help.users.profileTitle') }}</h3>
                </div>
                
                <v-card class="border rounded-xl pa-5" variant="flat">
                  <p class="text-body-2 text-medium-emphasis mb-4 leading-relaxed">{{ t('help.users.profileIntro') }}</p>
                  
                  <v-card border variant="outlined" class="rounded-lg overflow-hidden">
                    <v-table>
                      <thead>
                        <tr class="bg-grey-lighten-4">
                          <th class="font-weight-bold text-caption">{{ t('help.users.table.action') }}</th>
                          <th class="text-center font-weight-bold text-caption" style="width: 100px;">{{ t('help.users.table.allowed') }}</th>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <v-icon color="success" size="18" :aria-label="t('yes')" role="img">mdi-check-circle</v-icon>
                          </td>
                          <td class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.users.table.changePasswordDetails') }}</td>
                        </tr>
                        <tr>
                          <td class="font-weight-bold text-caption">{{ t('help.users.table.changeName') }}</td>
                          <td class="text-center">
                            <v-icon color="error" size="18" :aria-label="t('no')" role="img">mdi-close-circle</v-icon>
                          </td>
                          <td class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.users.table.changeNameDetails') }}</td>
                        </tr>
                        <tr>
                          ...
                          <td class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.users.table.changeEmailDetails') }}</td>
                        </tr>
                      </tbody>
                    </v-table>
                  </v-card>
              ...
              <!-- Section 3: Services -->
              <section id="services-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-open-in-new</v-icon>
                  </v-avatar>
                  <h3 class="text-h5 font-weight-bold text-slate-800">{{ t('help.users.navigationTitle') }}</h3>
                </div>

                <v-card class="border-light rounded-xl pa-5 mb-6" variant="flat">
                  <v-timeline density="compact" align="start" class="mb-4">
                    <v-timeline-item dot-color="primary" size="small" icon="mdi-gesture-tap">
                      <div class="text-body-2 text-medium-emphasis leading-relaxed">{{ t('help.users.navigationText1') }}</div>
                    </v-timeline-item>
                    <v-timeline-item dot-color="success" size="small" icon="mdi-door-open">
                      <div class="text-body-2 text-medium-emphasis leading-relaxed">{{ t('help.users.navigationText2') }}</div>
                    </v-timeline-item>
                  </v-timeline>
              ...
              <section id="reset-password-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-lock-open-outline</v-icon>
                  </v-avatar>
              ...
              <section id="troubleshooting-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-alert-circle-outline</v-icon>
                  </v-avatar>
                  <h3 class="text-h5 font-weight-bold text-slate-800">{{ t('help.troubleshooting.title') }}</h3>
                </div>

                <v-expansion-panels variant="accordion" class="border-light rounded-xl overflow-hidden elevation-0">
                  <v-expansion-panel v-for="n in 4" :key="n">
          ...
          <v-window-item value="admins">
            ...
            <div class="sections-wrapper">
              ...
              <section id="create-users-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-account-plus-outline</v-icon>
                  </v-avatar>
                ...
                <v-card class="border-light rounded-xl pa-5" variant="flat">
                  ...
                  <v-timeline density="compact" align="start" truncate-line="both">
                    <v-timeline-item dot-color="grey-darken-1" size="small" icon="mdi-numeric-1">
                      <div class="font-weight-bold text-body-2">{{ t('help.admins.createStep1Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.admins.createStep1Text') }}</div>
                    </v-timeline-item>
                    <v-timeline-item dot-color="grey-darken-1" size="small" icon="mdi-numeric-2">
                      <div class="font-weight-bold text-body-2">{{ t('help.admins.createStep2Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.admins.createStep2Text') }}</div>
                    </v-timeline-item>
                    <v-timeline-item dot-color="grey-darken-1" size="small" icon="mdi-numeric-3">
                      <div class="font-weight-bold text-body-2">{{ t('help.admins.createStep3Title') }}</div>
                      <div class="text-caption text-medium-emphasis leading-relaxed">{{ t('help.admins.createStep3Text') }}</div>
                    </v-timeline-item>
                  </v-timeline>
                </v-card>
              </section>
              ...
              <section id="edit-users-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
              ...
              <section id="classes-section" class="scroll-target py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-google-classroom</v-icon>
                  </v-avatar>
                ...
                <v-card class="border-light rounded-xl pa-5" variant="flat">
                  ...
                  <div class="d-flex align-start ga-3 bg-indigo-lighten-5 pa-4 rounded-xl mt-4">
                    <v-icon color="primary" class="mt-0.5">mdi-information-outline</v-icon>
                    <div>
                      ...
                      <div class="d-flex align-center flex-wrap ga-1 mt-2 text-caption font-weight-bold text-primary">
                        ...
                        <v-icon size="14" class="mx-0.5">mdi-chevron-right</v-icon>
              ...
              <section class="py-4 mb-8">
                <div class="d-flex align-center mb-4 ga-3">
                  <v-avatar color="indigo-lighten-5" rounded="lg" size="40">
                    <v-icon color="primary" size="22">mdi-database-import-outline</v-icon>
                  </v-avatar>
